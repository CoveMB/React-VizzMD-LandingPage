  ...
  return (
    <Fragment>
      ...
      <div className="headerCardText">
        ...
        <p><img style={{ marginLeft: "15px" }} className="svgDone" src="/static/images/donesvg.svg" alt="svg done" /><strong className="darkblueTitle">Numériques</strong> (standardisées et rapide d’accès)</p>
